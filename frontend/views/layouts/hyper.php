...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <!-- App css -->
        <link href="/theme/css/app-saas.min.css" rel="stylesheet" type="text/css" id="app-style"/>

        <!-- Icons css -->
        <link href="/theme/css/icons.min.css" rel="stylesheet" type="text/css"/>
        <?php $this->registerJsFile('/theme/js/hyper-config.js', ['position' => \yii\web\View::POS_HEAD]); ?>
        <?= $this->head() ?>
    </head>
            ...
            <div class="topbar container-fluid">
                <div class="d-flex align-items-center gap-lg-2 gap-1">
                    ...
                    <div class="logo-topbar">
                        ...
                        <a href="index.html" class="logo-light">
                            ...
                            <span class="logo-sm">
                                    <img src="/theme/images/logo-sm.png" alt="small logo">
                                </span>
                        </a>
                        ...
                        <a href="index.html" class="logo-dark">
                                <span class="logo-lg">
                                    <img src="/theme/images/logo-dark.png" alt="dark logo">
                                </span>
                            <span class="logo-sm">
                                    <img src="/theme/images/logo-dark-sm.png" alt="small logo">
                                </span>
                        </a>
                    </div>
                    ...
                    <div class="app-search dropdown d-none d-lg-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="/theme/images/users/avatar-2.jpg"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="/theme/images/users/avatar-5.jpg"
                                             alt="Generic placeholder image" height="32">
                                        <div class="w-100">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            <img src="/theme/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1" height="12">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="/theme/images/flags/germany.jpg" alt="user-image" class="me-1" height="12">
                                <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="/theme/images/flags/italy.jpg" alt="user-image" class="me-1" height="12">
                                <span class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="/theme/images/flags/spain.jpg" alt="user-image" class="me-1" height="12">
                                <span class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="/theme/images/flags/russia.jpg" alt="user-image" class="me-1" height="12">
                        ...
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                           role="button" aria-haspopup="false" aria-expanded="false">
                                <span class="account-user-avatar">
                                    <img src="/theme/images/users/avatar-1.jpg" alt="user-image" width="32"
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="leftbar-user">
                    <a href="pages-profile.html">
                        <img src="/theme/images/users/avatar-1.jpg" alt="user-image" height="42"
            ...
            <div class="modal-content modal-filled bg-danger">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <h4 class="mt-2">Удаление элемента!</h4>
                        <p class="mt-3 content-text">Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
                        <a href="#" class="btn btn-light my-2" data-bs-dismiss="modal">Отмена</a>
                        <a href="#" class="btn btn-warning my-2" data-method="post">Удалить</a>
                    </div>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
